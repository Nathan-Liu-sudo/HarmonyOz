    ...
    <div class="flex">
      <div class="w-4/6 my-auto align-center px-16">
        <p class="text-justify">
          In Australia, the recognition of courses and qualifications is primarily governed by the Australian
          Qualifications Framework (AQF). Courses and qualifications offered by institutions that are not accredited by
          the appropriate authorities may not be recognized.
        </p>

      </div>
      <div class="w-2/6 block">
        <!-- <div class="w-5/6 flex mx-auto"> -->
        <img class="w-5/6 mx-auto" src="../../assets/job_study.jpg" />
        <!-- </div> -->
      </div>
    </div>
    <div class="collapse bg-base-200 mt-10">
      <input type="checkbox" class="peer" />
      <div class="collapse-title text-center text-white">
        Learn more
      </div>
      <div class="collapse-content bg-white border-2">
